...
class MyRobot(magicbot.MagicRobot):
    ...
    def createObjects(self):
        ...
        # Drive motors
        self.rr_module = swervemodule.SwerveModule(ctre.CANTalon(30), wpilib.VictorSP(3), wpilib.AnalogInput(0), sd_prefix='rr_module', zero=1.85, has_drive_encoder=True)
        self.rl_module = swervemodule.SwerveModule(ctre.CANTalon(20), wpilib.VictorSP(1), wpilib.AnalogInput(2), sd_prefix='rl_module', zero=3.92, inverted=True)
        self.fr_module = swervemodule.SwerveModule(ctre.CANTalon(10), wpilib.VictorSP(2), wpilib.AnalogInput(1), sd_prefix='fr_module', zero=4.59)
        self.fl_module = swervemodule.SwerveModule(ctre.CANTalon(5), wpilib.VictorSP(0), wpilib.AnalogInput(3), sd_prefix='fl_module', zero=2.44, has_drive_encoder=True, inverted=True)
